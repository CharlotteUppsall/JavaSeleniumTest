...
public class StartTrainingTestarModel {
    ...
    public static By SettingsInStartTrainingTestarModel = By.xpath("//*[@id=\"app\"]/div[12]/div/div[1]/div[1]/div/div/nav/div/div[1]/a/div/i");
    public static By CloseButtonInStartTrainingTestarModel = By.id("close-button");
    public static By AddAlabelInStartTrainingTestarModel = By.xpath("//*[@id=\"add-label\"]/div/span");
}
